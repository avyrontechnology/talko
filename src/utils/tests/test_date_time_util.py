...
class TestParseTimeStr:
    def test_parse_valid_range(self):
        ...
        # Act
        result = TalkoDateTimeUtil.parse_time_str(time_range)
    ...
    def test_parse_invalid_range_end_smaller_than_start(self):
        ...
        with pytest.raises(ValueError) as exc:
            TalkoDateTimeUtil.parse_time_str(time_range)
    ...
    def test_parse_empty_string(self):
        assert TalkoDateTimeUtil.parse_time_str("") == (None, None)

    def test_parse_none(self):
        assert TalkoDateTimeUtil.parse_time_str(None) == (None, None)
